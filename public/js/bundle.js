...
/***/ (function(module, exports, __webpack_require__) {
	...
	var UsersList = function (_React$Component) {
		...
		function UsersList() {
			...
			return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = UsersList.__proto__ || Object.getPrototypeOf(UsersList)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
				users: []
		...
		_createClass(UsersList, [{
			...
			value: function componentDidMount() {
				...
				_axios2.default.get('https://jsonplaceholder.typicode.com/users').then(function (result) {
					console.log(result);
					_this2.setState({ users: result.data });
				});
			}
		}, {
			key: 'render',
